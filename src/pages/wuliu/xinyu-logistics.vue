	...
	<view class="page">
		...
		<view class="express">
			<view class="top ali-c">
				...
				<view class="text">
					<view class="text1">{{wlInfo.EBusinessID}}</view>
					<view class="text2">快递单号{{wlInfo.LogisticCode}}</view>
				</view>
			</view>
		<!-- 	<view class="right">
		...
		<view class="content bgf">
			<view>
				...
				<view class="flex list" :class="{one: index == 0 && wlInfo.State == 1}" v-for="(item, index) in wlInfo.Traces"
				 :key="index">
					<view class="time">
					...
					<view class="info flex1">
						<view class="title">{{index == 0 && wlInfo.State == 1 ? '已签收' : '配送中'}}</view>
