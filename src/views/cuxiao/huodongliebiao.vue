	...
	<div>
		...
		<div class="shopalllist">
			<el-table ref="multipleTable" @selection-change="handleSelectionChange" :data="tableData" :border="true">
				...
				<el-table-column prop="spuName" label="活动名称">
				</el-table-column>
				<el-table-column prop="city" label="开始时间">
					v
				</el-table-column>
				<el-table-column prop="zip" label="结束时间">
				</el-table-column>
				<el-table-column prop="zip" label="上线/下架">
				</el-table-column>
				...
				<el-table-column label="操作">
					<template slot-scope="scope">
						...
						<el-button type="text" @click="handleClick(scope.row)" size="small">发布到广告 </el-button>
